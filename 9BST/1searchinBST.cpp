...
BinaryTree<int> * searchBST( BinaryTree<int> * root,int element)
{
if(root==NULL)
{return NULL;}
...
if(element> root->data){ return searchBST(root->right,element);}
if(element< root->data){ return searchBST(root->left, element);}
else
{cout<<"not found"<<endl;
return NULL;}
}
...
cout<<searchBST(root,element)->data;
return 0;
}